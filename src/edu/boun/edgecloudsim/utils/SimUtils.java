...
//	}
	...
	public static SimInputConfig.PLACE_TYPES stringToPlace(String attractiveness){
		SimInputConfig.PLACE_TYPES placeType = null;
		if(attractiveness.equals("1"))
			placeType = SimInputConfig.PLACE_TYPES.ATTRACTIVENESS_L1;
		else if(attractiveness.equals("2"))
			placeType = SimInputConfig.PLACE_TYPES.ATTRACTIVENESS_L2;
		else if(attractiveness.equals("3"))
			placeType = SimInputConfig.PLACE_TYPES.ATTRACTIVENESS_L3;
		else{
			SimLogger.printLine("Unknown attractiveness level! Terminating simulation...");
	    	System.exit(0);
		}
